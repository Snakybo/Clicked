...
local KeyboardLayoutQwertz = {
	keys = {
		...
		{ key="CAPSLOCK", x=0, yOffset=1, width=1.65, relativeTo="TAB" },
		{ key="A" },
		{ key="S" },
		{ key="D" },
		{ key="F" },
		...
		{ key="LSHIFT", x=0, yOffset=1, width=1.25, relativeTo="CAPSLOCK", disabled=true },
		{ key="<" },
		{ key="Y" },
		{ key="X" },
		{ key="C" },
		...
		{ key="." },
		{ key="-" },
		{ key="RSHIFT", width=2.75, disabled=true },

		{ key="LCTRL", x=0, yOffset=1, width=1.75, relativeTo="LSHIFT", disabled=true },
		{ key="LMETA", width=1.15, disabled=true },
		{ key="LALT", width=1.15, disabled=true },
		{ key="SPACE", width=6.15 },
		{ key="RALT", width=1.15, disabled=true },
		{ key="RMETA", width=1.15, xOffset=1.15, disabled=true },
		{ key="RCTRL", width=1.35, disabled=true },
...
local KeyboardLayoutAzerty = {
	keys = {
		...
		{ key="LCTRL", x=0, yOffset=1, width=1.2857, relativeTo="LSHIFT", disabled=true },
		{ key="LMETA", width=1.2857, disabled=true },
		{ key="LALT", width=1.2857, disabled=true },
		{ key="SPACE", width=6 },
		{ key="RALT", width=1.28, disabled=true },
		{ key="RMETA", width=1.2857, xOffset=1.2857, disabled=true },
		{ key="RCTRL", width=1.2857, disabled=true },
