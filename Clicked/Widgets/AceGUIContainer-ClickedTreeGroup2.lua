...
--- @class ClickedTreeGroup2Item
--- @field public uid integer
--- @field public title string
--- @field public subtitle? string
--- @field public icon? string|integer
--- @field public enabled? boolean
--- @field public children? ClickedTreeGroup2Item[]

--- @class ClickedTreeGroup2RuntimeItem : ClickedTreeGroup2Item
--- @field public level integer
--- @field public parent? ClickedTreeGroup2Item
...
--- @class ClickedTreeGroup2Button : Button
--- @field public uid integer
--- @field public obj ClickedTreeGroup2
...
local Type, Version = "ClickedTreeGroup2", 1
...
--- @param button ClickedTreeGroup2Button
--- @param key string
...
local function Button_OnDragStop(button)
	...
	--- @type ClickedTreeGroup2RuntimeItem
...
--- @class ClickedTreeGroup2 : AceGUIContainer
--- @field private status? ClickedTreeGroup2Status
--- @field private localstatus ClickedTreeGroup2Status
--- @field private tree? ClickedTreeGroup2RuntimeItem[]
--- @field private treeLookup { [integer]: ClickedTreeGroup2RuntimeItem }
--- @field private sortMethod? fun(left: ClickedTreeGroup2Item, right: ClickedTreeGroup2Item): boolean
...
--- @field private lines ClickedTreeGroup2RuntimeItem[]
--- @field private buttons ClickedTreeGroup2Button[]
...
--- @private
--- @return ClickedTreeGroup2Button
function Methods:CreateButton()
	local num = AceGUI:GetNextWidgetNum("ClickedTreeGroup2Button")

	local button = CreateFrame("Button", ("ClickedTree2Button%d"):format(num), self.treeFrame, "OptionsListButtonTemplate") --[[@as ClickedTreeGroup2Button]]
...
--- @param status? ClickedTreeGroup2Status
...
--- @param method fun(left: ClickedTreeGroup2Item, right: ClickedTreeGroup2Item): boolean
...
--- @param tree ClickedTreeGroup2Item[]
...
function Methods:RefreshTree(scrollToSelection, fromOnUpdate)
	...
	--- @return ClickedTreeGroup2RuntimeItem?
...
function Methods:UpdateLines()
	...
	--- @param children ClickedTreeGroup2RuntimeItem[]
...
--- @private
--- @param button ClickedTreeGroup2Button
--- @param line ClickedTreeGroup2RuntimeItem
...
--- @private
--- @param tree? ClickedTreeGroup2RuntimeItem[]
--- @param level? integer
--- @param parent? ClickedTreeGroup2RuntimeItem
...
--- @private
--- @param item ClickedTreeGroup2RuntimeItem
--- @return boolean
