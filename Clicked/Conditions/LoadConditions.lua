...
local config = {
	...
	},
	{
		...
		disabled = Addon.EXPANSION < Addon.Expansions.MOP,
		init = function()
	...
	},
	{
		...
		dependencies = { "class", "specialization" },
		disabled = Addon.EXPANSION < Addon.Expansions.BFA,
		init = function()
			return Utils.CreateTalentLoadOption("")
		end,
		unpack = Utils.UnpackTalentLoadOption,
	...
	},
	{
		...
		unpack = Utils.UnpackSimpleLoadOption,
		testOnEvents = Addon.EXPANSION > Addon.Expansions.CLASSIC and
	...
	},
	{
		...
		disabled = Addon.EXPANSION > Addon.Expansions.CLASSIC or C_Engraving == nil,
		init = function()
			return Utils.CreateLoadOption("")
		end,
		unpack = Utils.UnpackSimpleLoadOption,
