...
L["Importing into profile: %s"] = true
L["Import external profile data into your current profile, or export the current profile into a sharable format."] = true
L["Immediately share the current profile with another player. The target player must allow profile sharing first."] = true
L["Import"] = true
L["Export"] = true
...
L["%s has send you a Clicked profile, do you want to apply it? This will overwrite the current profile."] = true
L["Unable to send a message to %s. Make sure that they are online and have allowed profile sharing."] = true
