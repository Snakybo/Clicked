...
L["Include spell subtext"] = true
L["Append the spell subtext to the cast command, e.g. Whirling Surge(Skyriding). Enable this if the spell does not cast without it."] = true
