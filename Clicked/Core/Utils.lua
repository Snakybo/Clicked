...
function Addon:GetBindingValue(binding)
	...
	if binding.actionType == Clicked2.ActionType.SPELL then
		...
		if Addon.EXPANSION <= Addon.Expansions.WOTLK and not binding.action.spellMaxRank and C_Spell.IsSpellDataCached(spell) then
...
function Addon:GetSpellInfo(input, addSubText)
	...
	if spell ~= nil and Addon.EXPANSION <= Addon.Expansions.WOTLK and addSubText and C_Spell.IsSpellDataCached(spell.spellID) then
